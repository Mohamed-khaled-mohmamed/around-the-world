  ...
  return (
    <div className="w-11 h-6 md:w-14 md:h-8 flex  gap-2 dark:gap-1 items-center rounded-full bg-toggelLight dark:bg-toggelDark  md:mr-[95px] sm:mr-[50px] mr-[10px]" onClick={toggleDarkMode}>
      ...
      <button className="w-4 h-4 md:w-6 md:h-6  rounded-full  bg-backgroundLight dark:bg-backgroundDark">
        <svg width="14" height="13" viewBox="0 0 14 13" fill="" xmlns="http://www.w3.org/2000/svg" className='w-full h-full dark:w- rounded-3xl  fill-toggelDark  dark:fill-white'>
          <path
