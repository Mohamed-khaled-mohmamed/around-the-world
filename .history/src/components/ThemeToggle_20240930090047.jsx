  ...
  return (
    <div className="w-11 h-6 md:w-14 md:h-8 flex  gap-2 dark:gap-1 items-center rounded-full bg-toggelLight dark:bg-toggelDark  md:mr-[95px] sm:mr-[50px] mr-[10px]" onClick={toggleDarkMode}>
      ...
      <button className="w-4 h-4 md:w-6 md:h-6  rounded-full  flex justify-center items-center bg-backgroundLight dark:bg-toggelDark">
        <svg width="16" height="15" viewBox="0 0 14 13" fill="" xmlns="http://www.w3.org/2000/svg" className="w-full h-full dark:w-4 dark:h-4 fill-toggelDark  dark:fill-white">
          <path
      ...
      <button className="w-4 h-4 md:w-6 md:h-6   bg-toggelDark  dark:bg-transparent rounded-full ">
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" className='dark:w-full dark:h-full fill-white  dark:fill-white'>
          <path
            fillRule=""
            clipRule="evenodd"
