...
function MainContent() {
  ...
  return (
    <div  className='bg-mainContentLight  dark:bg-mainContentDark grid justify-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 px-20 py-32'>
