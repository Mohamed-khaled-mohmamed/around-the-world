...
function MainContent() {
  ...
  const ArabCountries = ['Palestine' , 'Egypt'  , 'Morocco' , 'Kingdom of SaudiArabia' ]
  return (
    <div  className='bg-mainContentLight  dark:bg-mainContentDark grid justify-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-20 px-20 py-32'>
      ...
      {countries.map((country) => (
       ArabCountries.includes(country.name.common.tr)   ? <CountryCard key={country.name.common} country={country} /> : ""
      ))}
    </div>
